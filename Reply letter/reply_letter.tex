...
\textbf{Reply}: Thank you for your remark. Indeed, for $C=17$ and $C=19$ we erroneously reported the RMSE values early experiments. The figure has been modified by reporting the correct values.
...
\textbf{Reply}: Thank you for your comment. \textcolor{red}{TODO} - discussion: some procedures, like transfer learning or pre-training of the networks can be implemented in a real world application, but necessarily the network have to be fine-tuned on the data taken from the target operation environment.
