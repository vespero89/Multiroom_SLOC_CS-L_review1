...
\textcolor{red}{
Hence, in order to reduce the fluctuations of location predictions, a median filter on each of the Cartesian coordinates (assumed to be independent \cite{vermaak2001nonlinear}) has been used as smoothing technique. % and different window size have been evaluated for the best performing setups of the different methods.
}
