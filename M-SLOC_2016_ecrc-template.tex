...
as we can notice from the table \tableref{tab:bestCONF_SIMU}.
...
%ndFAB Results discussion - 6c)
It can be noticed that a similar trend of performance with respect to temporal resolution (i.e., equal to $C\cdot s$) of the input values is registered.
%%
