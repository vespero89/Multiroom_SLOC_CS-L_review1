...
%%ndFAB - 1a)
The main contribution of this work is the development of a completely data-driven approach for a single Speaker Localization (SLOC) in a multi-room environment, considering both the moving and the stationary condition.
%%%
...
%%ndFAB - 1a)
We evaluated also the effect of combining source from multiple microphone pairs on the localization accuracy.
%%%
...
\end{figure*}
%TODO ci sarebbero da modificare le coordinate nella figura con \left \langle \chi,\psi \right \rangle \left [mm\right ]
